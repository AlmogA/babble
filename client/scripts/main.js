...
function displayMessages(messages) {
    ...
    for (var i = 0; i < messages.length; i++) {
        ...
        append += '<img src="' + message.img + '" alt="" class="u-md-floatLeft"> ';
        append += '<div class="Message u-md-floatLeft u-borderGrey" tabindex=0> ';
...
function shrinkWrap(index) {
    ...
    if (!maxWidth) {
        maxWidth = (Number(document.querySelector("ol").offsetWidth) * 92.0 / 100.0) - 70.0;
    }
